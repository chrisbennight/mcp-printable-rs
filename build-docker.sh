...
python3 -m compileall -q addon scripts/verify_release_image.py scripts/release_security.py
...
echo "==> Published ${server_commit_tag}, ${blender_commit_tag}, and ${pair_ref}"
